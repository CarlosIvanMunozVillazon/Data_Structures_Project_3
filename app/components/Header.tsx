...
export const Header: React.FC<HeaderProperties> = ({ title, description, element }: HeaderProperties) => {
    ...
    // height : "100%" toma el 100% de la altura del contenedor, con un ancho estático de 300px */ al reves
    ...
    return (
        <div>
            <Box sx={{ width: "100%", height: "350px" }}> 
                <Grid //padre que da ancho global el box de arriba
                    container
                    direction="row"
                    justifyContent="center"
                    alignItems="center"
                    sx={{ height: "100%" }} //a pesar de que es el 100%, toma el ancho total del padre
                >
                    <Grid item xs={5}>
